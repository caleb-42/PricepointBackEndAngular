...
class Backup_Database {
     ...
     */
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8', $sesn) {
        $this->host            = $host;
        ...
        $this->backupFile      = 'myphp-backup-'.$this->dbName.'-'.$sesn.'.sql';
...
function backup($sesn){
$backupDatabase = new Backup_Database(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME, CHARSET,$sesn);
